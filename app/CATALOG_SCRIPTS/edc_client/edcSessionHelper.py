...
see: https://github.com/Informatica-EIC/REST-API-Samples/blob/master/python/edcSessionHelper.py
...
class EDCSession:
    ...
    def initUrlAndSessionFromEDCSettings(self, args):
        """
        ...
        if args.envfile is not None:
            ...
            if pathlib.Path(args.envfile).is_file():
                ...
                edcurl = os.environ.get("INFA_EDC_URL")
                ...
                edcauth = os.environ.get("INFA_EDC_AUTH")
